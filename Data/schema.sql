...
VALUES
    ('Kasap Hasan',     'Kasap',     'Kasabadaki eski kasap, herkesin tanıdığı sert bir figür.',     50, 20, 0, 'O gece dükkanını kapattıktan sonra Osman Bey ile hesaplaşmak için evine gitti. Amacı sadece Osman''ın ona olan uzun süreli borcunu tahsil etmekti. Ancak Osman Bey alaycı bir tavırla borcunu ödemeyeceğini söyleyince Hasan kontrolünü kaybetti. Yanında getirdiği satırla bir anlık öfke krizine girerek Osman''ı katletti. Kanlı satırını panikle dükkanında saklamaya çalışırken etrafa izler bıraktı.', 1, 'images/hasan.png', 'images/butcher_interior.png'),
    ('Eczacı Selma',    'Eczane',    'Eczane sahibi, ilaç ve zehir konusunda uzman bir kadın.',      50, 45, 0, 'Yıllardır kasabada sessiz sedasız çalışan Selma, aslında Osman Bey''in kendisini gizlice tehdit etmesinden bıkmıştı. O gece, Osman''ın her gün aldığı kalp ilacına kendi serasında yetiştirdiği ölümcül ve iz bırakmayan özel bir zehirli sarmaşık özünü ekledi. Osman ilacını içtikten kısa süre sonra kalp krizi geçiriyormuş gibi kıvranarak can verdi. Selma ise sadece uzaktan izledi ve boş şişeyi dükkanında sakladı.',           1, 'images/selma.png', 'images/apothecary_interior.png'),
    ('Muhtar Kemal',    'Muhtarlık', 'Kasabanın muhtarı, herkesin sırrını bilen bir politikacı.',     50, 60, 0, 'Yaklaşan belediye seçimleri ve gizli arazi anlaşmaları için Osman''ın arsasına ihtiyacı vardı. Osman arsasını satmamak için direnince Kemal işleri kendi çözmeye karar verdi. Gece yarısı Osman''ın evine sızdı, aralarında çıkan şiddetli arbedede Osman''ı sert bir cisimle darp ederek öldürdü. Kendi sahte tapularını ve cinayet kanıtı sayılabilecek gözlüğünü panikle ofisinde unutarak arkasında büyük bir iz bıraktı.',                   1, 'images/kemal.png', 'images/town_hall_interior.png'),
    ('Komiser Güneş',   'Karakol',   'Kasabanın kadın polis komiseri, sarışın ve kararlı.',           50, 30, 0, 'Adaletin savunucusu olması beklenen Güneş, aslında yıllardır Osman''dan rüşvet alıyordu. Osman şantaja boyun eğmeyip Güneş''i ihbar etmekle tehdit edince işler değişti. O gece kurbanın evine giderek onu kendi polis copuyla darp etti. Kurbanın son çırpınışları sırasında Güneş''in rozeti ve paltosunun düğmesi koptu. Güneş, bir polis olarak olay yerini profesyonelce temizlemeye çalışsa da kendi düşürdüğü delilleri karanlıkta fark edemedi.',                       1, 'images/gunes.png', 'images/police_interior.png'),
    ('Terzi Yahya',     'Terzi',     'Kasabanın yaşlı terzisi, kurbana son kıyafeti diken kişi.',     50, 35, 0, 'Yahya, kurbanın sadece bir terzisi değil, karanlık işlerindeki gizli ortağıydı. Osman Bey, son diktirdiği ceketin gizli cebine çok önemli bir USB bellek yerleştirmiş ve Yahya''yı saf dışı bırakmaya çalışmıştı. Cinayet gecesi Yahya parasını istemek için Osman''ın evine gitti. Hakarete uğrayınca yılların birikimiyle patlayan Yahya, dikiş makarasındaki sağlam ipliği Osman''ın boynuna dolayarak onu acımasızca boğdu. Kumaş yırtıkları, o geceki ölüm kalım savaşının son şahidi oldu.',              1, 'images/yahya.png', 'images/tailor_interior.png');
